...
export default function ItemsList({ mainText, highlightedText, description }) {
  return (
    <div className="mb-12 text-[#FAFAFA]">
      <span className="mx-auto block text-sm leading-[22px] px-6 py-2 bg-[#393C3E] rounded-lg mb-1 border border-[#4a4a4a] w-fit cursor-pointer">
        راه‌کار ‌ها
      </span>
      ...
      <div className="bg-[#FB6514] flex gap-x-2 rounded-md px-3 py-2 items-center w-fit mx-auto cursor-pointer">
